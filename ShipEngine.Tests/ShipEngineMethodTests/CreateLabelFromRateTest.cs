...
namespace ShipEngineTest
{
    public class CreateLabelFromRateTest
    {
        ...
        public async void ValidateCustomSettingsAtMethodLevel()
        {
            ...
            var voidLabelResult = JsonConvert.DeserializeObject<ShipEngineSDK.CreateLabelFromRate.Result.LabelResult>(json);
            ...
            mockHandler
                .Setup(x => x.SendHttpRequestAsync<ShipEngineSDK.CreateLabelFromRate.Result.LabelResult>
                (
                    It.IsAny<HttpMethod>(),
                    It.IsAny<string>(),
                    It.IsAny<string>(),

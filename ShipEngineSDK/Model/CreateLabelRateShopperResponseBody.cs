...
public partial class CreateLabelRateShopperResponseBody
{
    ...
    /// </summary>
    /// <value>The rate selection strategy that was used to create this label. This will match the rate_shopper_id provided in the request path. </value>
    ...
    public class RateShopperIdEnum
    {
        ...
        /// </summary>
        /// <param name="value">The value of the RateShopperIdEnum</param>
        /// <remarks>
    ...
    internal class RateShopperIdEnumJsonConverter : JsonConverter<RateShopperIdEnum>
    {

...
public partial class AddressValidatingShipment
{
    ...
    [JsonPropertyName("confirmation"), JsonPropertyOrder(8)]
    ...
    [JsonPropertyName("insurance_provider"), JsonPropertyOrder(13)]
    public InsuranceProvider? InsuranceProvider { get; set; }

    /// <summary>
    /// Gets or Sets OrderSourceCode
    /// </summary>
    [JsonPropertyName("order_source_code"), JsonPropertyOrder(17)]
    ...
    /// </summary>
    [JsonPropertyName("validate_address"), JsonPropertyOrder(27)]
    ...
    /// </example>
    [JsonPropertyName("service_code"), JsonRequired, JsonPropertyOrder(2)]
    ...
    [JsonPropertyName("ship_from"), JsonRequired, JsonPropertyOrder(3)]
    ...
    [JsonPropertyName("ship_to"), JsonRequired, JsonPropertyOrder(4)]
    ...
    [JsonPropertyName("advanced_options"), JsonPropertyOrder(6)]
    ...
    /// retail
    /// </example>
    [JsonPropertyName("comparison_rate_type"), JsonPropertyOrder(7)]
    ...
    [JsonPropertyName("customs"), JsonPropertyOrder(10)]
    ...
    [JsonPropertyName("external_order_id"), JsonPropertyOrder(11)]
    ...
    [JsonPropertyName("external_shipment_id"), JsonPropertyOrder(12)]
    ...
    [JsonPropertyName("is_return"), JsonPropertyOrder(14)]
    ...
    [JsonPropertyName("items"), JsonPropertyOrder(15)]
    ...
    [JsonPropertyName("packages"), JsonPropertyOrder(18)]
    ...
    [JsonPropertyName("return_to"), JsonPropertyOrder(19)]
    ...
    /// 2018-09-23T00:00Z
    /// </example>
    [JsonPropertyName("ship_date"), JsonPropertyOrder(20)]
    ...
    [JsonPropertyName("shipment_number"), JsonPropertyOrder(21)]
    ...
    /// se-28529731
    /// </example>
    [JsonPropertyName("shipping_rule_id"), JsonPropertyOrder(23)]
    ...
    /// </summary>
    [JsonPropertyName("tax_identifiers"), JsonPropertyOrder(25)]

...
public class ConnectCarrierRequestBodyJsonConverter : JsonConverter<ConnectCarrierRequestBody>
{
    ...
    private static readonly HashSet<string> MandatoryFields = ["AccessKey", "Account", "AccountCountryCode", "AccountNumber", "AccountPostalCode", "ActivationKey", "Address", "Address1", "AgreeToEula", "ApiKey", "ApiSecret", "AuthCode", "City", "ClientId", "ContactName", "ContractId", "CountryCode", "CustomerBranch", "DistributionCenter", "Email", "FirstName", "InductionSite", "LasershipCriticalEntryTime", "LasershipCriticalPullTime", "LastName", "MailerId", "MerchantSellerId", "MwsAuthToken", "Nickname", "Passphrase", "Password", "Phone", "PickupNumber", "PostalCode", "ProcessingLocation", "SendleId", "SiteId", "State", "Username", "WebServicesId", "WebServicesKey"];
